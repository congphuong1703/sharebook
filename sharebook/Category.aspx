<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="sharebook.Category" %>
    ...
    <div style="background-color: #5C8AC5;">
        <div class="container px-0">
            <div class="pil-wrapper">
                <canvas width="1140" height="168" class="pil-placeholder"></canvas>
                <div class="pil-tiny-wrapper pil-loaded">
                    <img alt="Viblo Contribution Event 2021" src="https://images.viblo.asia/60/688a2cf2-99b3-481c-abbe-16000a16c68b.png" width="1140" height="168" class="pil-tiny-img">
                </div>
                <div class="pil-original-wrapper pil-loaded">
                    <img alt="Viblo Contribution Event 2021" data-pil-src="https://images.viblo.asia/full/688a2cf2-99b3-481c-abbe-16000a16c68b.png" width="1140" height="168" class="pil-original-img" src="https://images.viblo.asia/full/688a2cf2-99b3-481c-abbe-16000a16c68b.png">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="feedbar-wrapper">
                        <ul class="feed-links">
                            ...
                            <asp:ListView ID="categories" runat="server">
                                <ItemTemplate>
                                    <li class="feedbar-item nuxt-link-exact-active active active"><a href="/Category?category_id=<%#Eval("category_id") %>" aria-current="page" class="feed-link posts-newest">
